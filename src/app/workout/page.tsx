...
export default function Home() {
  ...
  if (!process.env.NEXT_PUBLIC_SUPABASE_URL || !process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY) {
    return <main className="min-h-screen flex flex-col items-center justify-center gap-6 p-8 text-center"><h1 className="text-3xl">Your workout coach</h1><p className="max-w-lg text-gray-300">The original workout and voice coach needs account sign-in. Cloud setup is still pending for this preview. You can use your health agent, daily check-ins, and activity log now.</p><Link className="text-lime-300 underline" href="/">Back to Wolverine</Link></main>;
  }
